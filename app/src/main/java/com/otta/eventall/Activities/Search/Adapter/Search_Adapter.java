package com.otta.eventall.Activities.Search.Adapter;
...
public class Search_Adapter extends RecyclerView.Adapter {
    ...
    RequestOptions  options = new RequestOptions()
            .error(R.drawable.image_placeholder_withoutlogo)
            .placeholder(R.drawable.image_placeholder_withoutlogo);

    public Search_Adapter(Activity activity, List<BusinessModel> allBusinessList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        myViewHolder.Call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MarketingUtil.Call(activity.getApplicationContext(), myViewHolder.selectedBusiness.getMobileNumber());
            }
        });
        ...
        if(myViewHolder.selectedBusiness.getPhotos() != null){
            ...
            String[] spilted = myViewHolder.selectedBusiness.getPhotos().split(",");
...
//                        context.startActivity(OpenBusinessDetails);
                        ...
                        Intent OpenBusinessDetails = new Intent(activity.getApplicationContext(), DetailsPage.class);
                        OpenBusinessDetails.putExtra("BMODEL", myViewHolder.selectedBusiness);
                        OpenBusinessDetails.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        activity.startActivity(OpenBusinessDetails);
                    }
                });
    ...
    public static class myViewHolder extends RecyclerView.ViewHolder {
        ...
        public myViewHolder(@NonNull View itemView) {
            ...
            FontEngine.overrideTypeface(activity.getApplicationContext(), itemView);
