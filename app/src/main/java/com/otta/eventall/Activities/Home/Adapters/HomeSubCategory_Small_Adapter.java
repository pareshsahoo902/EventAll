...
public class HomeSubCategory_Small_Adapter extends RecyclerView.Adapter {
    ...
    public HomeSubCategory_Small_Adapter() {
    }

    public HomeSubCategory_Small_Adapter(Context context, FragmentManager fragmentManager, List<SubCategoryModel> SubCategoryList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView;
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_subcategory, parent, false);
